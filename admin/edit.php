<?php
	...
	if(isset($_POST['submit']))
	{
        ...
        if($er == 0)
        {
            ...
            `fathername` = '".strip_tags($fathername)."',
            `mothername` = '".strip_tags($mothername)."',
            `contact` = '".strip_tags($contact)."',
            `email` = '".strip_tags($email)."',
            `caste` = '".strip_tags($caste)."',
            `religion` = '".strip_tags($religion)."',
            `address` = '".strip_tags($address)."',
            `blgroup` = '".strip_tags($blgroup)."',
            `school` = '".strip_tags($school)."',
            `schooladdress` = '".strip_tags($schooladdress)."',
            `equalification` = '".strip_tags($equalification)."',
            `courseopt` = '".strip_tags($courseopt)."',
